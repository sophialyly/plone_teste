...
#
#  $ bin/test -s prodam.test -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src prodam.test.testing.PRODAM_TEST_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/prodam/test/tests/robot/test_example.robot
#
