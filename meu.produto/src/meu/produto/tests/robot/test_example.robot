...
#
#  $ bin/test -s meu.produto -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src meu.produto.testing.MEU_PRODUTO_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/meu/produto/tests/robot/test_example.robot
#
